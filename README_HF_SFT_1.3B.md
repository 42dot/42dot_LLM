...
Fine-tuning took about 2 hours using 8 * NVIDIA A100 GPUs. For training dataset, we manually constructed  (question/insturuction) and response pairs, which can either be single- or multi-turn. 
...
## License
The 42dot-SFT is licensed under the Creative Commons Attribution-NonCommercial 3.0 Unported (CC BY-NC 3.0) license.
